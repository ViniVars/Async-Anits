...
export default function Navbar() {
  ...
  useEffect(() => {
    if (sessionStorage.getItem("cat") == "admin") {
      SetNav(true);
    }
    if (sessionStorage.getItem("cat") == "tea") {
      SetTea(true);
    }
  ...
  return (
    <>
      <div className="nav1 set">
        <div className="logobrand">
          <span className="text-orange-700">A</span>
          <span>SYNC.</span>
        </div>
        <div className="nav-items set">
          {tea && (
            <Link href="/Dashboard">
            <div className="crecla set1">
              <div className="img">
                <svg
            ...
            <>
              <Link href="/CreateClass">
                <div className="crecla set1">
                  ...
                  <div className="set">Create Class</div>
                </div>
              </Link>
              <Link href="/MyClasses">
                <div className="crecla set1">
                  ...
                  <div className="set">Add Subject</div>
                </div>
              </Link>
            </>
          )}
          <Link href="/CheckAtt">
            <div className="crecla set1">
              ...
              <div className="set">View Atten</div>
            </div>
          </Link>
          {nav && (
            <Link href="/MyClasses">
              <div className="crecla set1">
                ...
                <div className="set">My Classes</div>
              </div>
            </Link>
          )}
          <Link href="/">
